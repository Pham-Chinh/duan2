{{-- Footer Component cho Frontend --}}
<footer class="bg-gray-900 text-gray-300 mt-16">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            {{-- About --}}
            <div>
                <h3 class="text-lg font-bold text-white mb-4">Về chúng tôi</h3>
                <p class="text-sm text-gray-400 leading-relaxed">
                    {{ config('app.name') }} - Website tin tức cập nhật nhanh và chính xác nhất.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white transition">Quảng cáo</a></li>
                </ul>
            </div>

            {{-- Categories --}}
            <div>
                <h3 class="text-lg font-bold text-white mb-4">Chuyên mục</h3>
                <ul class="space-y-2 text-sm">
                    @php
                    ...
                    @foreach($footerCategories as $cat)
                        <li>
                            <a href="{{ route('category.show', $cat->slug) }}" class="hover:text-white transition">
                                {{ $cat->name }}
                            </a>
                        </li>
                    @endforeach
            ...
            {{-- Newsletter --}}
            <div>
                <h3 class="text-lg font-bold text-white mb-4">Đăng ký nhận tin</h3>
                ...
                <form action="#" method="POST" class="flex flex-col gap-2">
                    ...
                    <input type="email" 
                           ...
                           class="rounded-lg border-gray-600 bg-gray-800 text-white px-4 py-2 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                    <button type="submit" 
