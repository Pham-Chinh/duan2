...
new #[Layout('components.layouts.app')] #[Title('Thêm Tài khoản Mới')]
class extends Component
{
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->dispatch('toast-notification', type: 'success', message: 'Thêm tài khoản thành công!');
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Thêm Tài khoản Mới</h1>
